...
This is a Jekyll-based personal blog and portfolio website for Solito Reyes III (solrey3), hosted on GitHub Pages. The site focuses on music reviews, album recommendations, personal content, and a public latest-newsletter page at `/news`.
...
- **Content Structure**:
  ...
  - `news/index.md`: Auto-generated latest dispatch page published from `~/pinky/raw/newsletters/`
...
- `news/index.md` is generated by `~/pinky/scripts/publish-latest-newsletter.sh`; prefer changing the Pinky publisher or News Correspondent skill rather than hand-editing long-term behavior here
- The `/news` page should keep readable high-contrast tables, linked market tickers/indexes, weather/forecast links, sports source/standings/box-score links, and clickable Squared Circle schedule/source URLs
...
- Includes explicit table overrides for public newsletter readability; the generated `/news` page also injects page-local table styling
